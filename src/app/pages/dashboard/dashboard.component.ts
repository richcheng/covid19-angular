...
import * as jsonCountryCodes from '../../../assets/files/country-codes.json';
...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  isModalShown = false;
  public countryCodes = new Map<string, string>();
  public modalStep = 0;
  showModal(): void {
    this.modalStep = 0;
  ...
  async ngOnInit() {
    this.countryCodes = new Map(JSON.parse(jsonCountryCodes.toString()));
